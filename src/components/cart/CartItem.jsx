      ...
      <div className="flex items-center justify-between w-full px-5 mb-5">
        ...
        <div className="grid items-center gap-5">
          ...
          <div className="grid items-center justify-center">
            <button
              type="button"
              className="shadow-sm shadow-red-500 active:scale-110 transition-all  bg-red-500 rounded p-1 lg:p-0.5 grid items-center justify-items-center cursor-pointer"
